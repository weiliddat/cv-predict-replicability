...
*th have been checked!
*update these means and standard deviations, 3.5*sd+-mean after exclusion has been made; 
* Time mean=123.4446240 SD=149.1979108 th==123.4446240 + (3.5*149.1979108)=645.6373118;
*if time >645.6373118 then time_check = 1;
if time_check = 1 then delete;

art_check = 0;
*wrong mean=1.1331058 SD=2.4868207 th=1.1331058 +(3.5*2.4868207)=9.83697825;
*if wrong > 9.83697825 then art_check = 1;
if art_check = 1 then delete;

score_check = 0;
*update scoretresshold mean=25.9453925 SD=5.3106014 th==25.9453925-(3.5*5.3106014)=7.3582876;
*if score < 7.3582876 then score_check = 1;
