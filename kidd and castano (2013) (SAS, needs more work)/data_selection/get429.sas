...
* Time mean=164.1884749 SD=416.4120515 th= 164.1884749+(3.5*416.4120515)=1621.63065515;
*if time >1621.63065515 then time_check = 1;
if time_check = 1 then delete;

art_check = 0;
*wrong mean=1.0755149 SD=2.2860306 th=1.0755149 +(3.5*2.2860306)=9.076622;
*if wrong > 9.076622 then art_check = 1;
if art_check = 1 then delete;

score_check = 0;
*update scoretresshold mean=25.3867277 SD=5.5779799 th=25.3867277-(3.5*5.5779799)=5.86379805;
*if score < 5.86379805 then score_check = 1;
